 ...
 * {@link org.wso2.developerstudio.eclipse.gmf.esb.DropMediator} object. <!--
...
public class DropMediatorItemProvider extends MediatorItemProvider {
	...
	/**
	 * This adds a property descriptor for the Output Connector feature. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addOutputConnectorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DropMediator_outputConnector_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DropMediator_outputConnector_feature", "_UI_DropMediator_type"),
				 EsbPackage.Literals.DROP_MEDIATOR__OUTPUT_CONNECTOR,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EsbPackage.Literals.DROP_MEDIATOR__OUTPUT_CONNECTOR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(EsbPackage.Literals.DROP_MEDIATOR__OUTPUT_CONNECTOR,
				EsbFactory.eINSTANCE.createDropMediatorOutputConnector()));
	}
