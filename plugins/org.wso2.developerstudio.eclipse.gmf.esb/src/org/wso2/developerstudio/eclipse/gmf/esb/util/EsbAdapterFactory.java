...
public class EsbAdapterFactory extends AdapterFactoryImpl {
	...
	protected EsbSwitch<Adapter> modelSwitch =
		new EsbSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDropMediatorOutputConnector(DropMediatorOutputConnector object) {
				return createDropMediatorOutputConnectorAdapter();
			}
			@Override
	...
	public Adapter createCommentMediatorAdapter() {
		return null;
				...
				/**
	 * Creates a new adapter for an object of class '{@link org.wso2.developerstudio.eclipse.gmf.esb.DropMediatorOutputConnector <em>Drop Mediator Output Connector</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.wso2.developerstudio.eclipse.gmf.esb.DropMediatorOutputConnector
	 * @generated
	 */
