...
public class EsbFactoryImpl extends EFactoryImpl implements EsbFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case EsbPackage.DROP_MEDIATOR_OUTPUT_CONNECTOR: return createDropMediatorOutputConnector();
			default:
	 ...
	 * @generated
	 */
	public DropMediatorOutputConnector createDropMediatorOutputConnector() {
		DropMediatorOutputConnectorImpl dropMediatorOutputConnector = new DropMediatorOutputConnectorImpl();
		return dropMediatorOutputConnector;
	}
	 ...
	 * @generated
	 */
	public CacheProtocolType createCacheProtocolTypeFromString(EDataType eDataType, String initialValue) {
		CacheProtocolType result = CacheProtocolType.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertCacheProtocolTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
